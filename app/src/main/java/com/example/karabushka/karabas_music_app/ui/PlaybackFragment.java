...
public class PlaybackFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie = (Movie) getActivity().getIntent().getSerializableExtra(VideoDetailsActivity.MOVIE);
    ...
    private void next(boolean autoPlay) {
        ...
        if (movie != null) {
            ((PlaybackActivity) getActivity()).setVideoPath(movie.getVideoUrl());
            ((PlaybackActivity) getActivity()).setPlaybackState(PlaybackActivity.LeanbackPlaybackState.PAUSED);
            ((PlaybackActivity) getActivity()).playPause(autoPlay);
        }
    ...
    private void addOtherRows() {
        ...
        HeaderItem header = new HeaderItem(0, "Other Videos");
